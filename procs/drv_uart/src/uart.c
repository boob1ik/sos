...
void uart_init (uint32_t instance, uint32_t baudrate, uint8_t parity, uint8_t stopbits, uint8_t datasize, uint8_t flowcontrol)
{
    ...
    HW_UART_UFCR_WR(instance, BF_UART_UFCR_RXTL(1) | UART_UFCR_RFDIV | BF_UART_UFCR_TXTL(2));
    ...
    HW_UART_UCR2_SET(instance, BM_UART_UCR2_TXEN | BM_UART_UCR2_RXEN | BM_UART_UCR2_SRST | BM_UART_UCR2_ATEN);
...
void receiver_ready_interrupt_enable (uint32_t instance)
{
    BW_UART_UCR1_RRDYEN(instance, 1);
}

void receiver_ready_interrupt_disable (uint32_t instance)
{
    BW_UART_UCR1_RRDYEN(instance, 0);
}

void transmitter_ready_interrupt_enable (uint32_t instance)
{
    BW_UART_UCR1_TRDYEN(instance, 1);
}

void transmitter_ready_interrupt_disable (uint32_t instance)
{
    BW_UART_UCR1_TRDYEN(instance, 0);
}
