...
void uart1_iomux_config(void)
{
    ...
    //HW_IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT_WR(0x00000003);
    // Mux Register:
    ...
    HW_IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT_WR(
            BF_IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT_DAISY_V(SD3_DATA6_ALT1));
    ...
    //HW_IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT_WR(0x00000002);
    // Mux Register:
    ...
    //     SD3_DATA6_ALT1 (3) - Select signal uart1 UART1_RX_DATA as input from pad SD3_DATA6(ALT1).
    //HW_IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT_WR(
    //        BF_IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT_DAISY_V(SD3_DATA7_ALT1));
}
