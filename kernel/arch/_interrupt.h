...
#define interrupt_enable_s(state) \
  asm volatile("                  \
  cmp     %0, #0                \n\
  beq     1f                    \n\
  cpsie   i                     \n\
...
enum target_irq_ids
{
    ...
    IMX_INT_ENET_1588 = 151,    //!< пїјMAC 0 1588 Timer interrupt [synchronous] request.
    ...
    Spurious1022_IRQ_ID            = 1006,             /**< Special Interrupt */
    Spurious1023_IRQ_ID            = 1007              /**< Special Interrupt */
} IRQ_ID_Type;
